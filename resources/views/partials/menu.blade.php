<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('access_control_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/careers*") ? "c-show" : "" }} {{ request()->is("admin/galleries*") ? "c-show" : "" }} {{ request()->is("admin/partners*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-fingerprint c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.accessControl.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('career_access')
                        <li class="c-sidebar-nav-item">
