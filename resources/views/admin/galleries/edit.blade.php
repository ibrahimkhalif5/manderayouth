    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.galleries.update", [$gallery->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="image_title">{{ trans('cruds.gallery.fields.image_title') }}</label>
                <input class="form-control {{ $errors->has('image_title') ? 'is-invalid' : '' }}" type="text" name="image_title" id="image_title" value="{{ old('image_title', $gallery->image_title) }}">
                @if($errors->has('image_title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('image_title') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.gallery.fields.image_title_helper') }}</span>
            </div>
            <div class="form-group">
