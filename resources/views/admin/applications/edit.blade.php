    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.applications.update", [$application->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('idno') ? 'is-invalid' : '' }}" type="number" name="idno" id="idno" value="{{ old('idno', $application->idno) }}" step="1" required>
                @if($errors->has('idno'))
                    <div class="invalid-feedback">
                        {{ $errors->first('idno') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender" required>
                    ...
                    @foreach(App\Models\Application::GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gender', $application->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="number" name="mobile" id="mobile" value="{{ old('mobile', $application->mobile) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('passport') ? 'is-invalid' : '' }}" name="passport" id="passport" required>
                    ...
                    @foreach(App\Models\Application::PASSPORT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('passport', $application->passport) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('passport_no') ? 'is-invalid' : '' }}" type="text" name="passport_no" id="passport_no" value="{{ old('passport_no', $application->passport_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('passport_date') ? 'is-invalid' : '' }}" type="text" name="passport_date" id="passport_date" value="{{ old('passport_date', $application->passport_date) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('pwd') ? 'is-invalid' : '' }}" name="pwd" id="pwd" required>
                    ...
                    @foreach(App\Models\Application::PWD_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('pwd', $application->pwd) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('pwd'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parent_name') ? 'is-invalid' : '' }}" type="text" name="parent_name" id="parent_name" value="{{ old('parent_name', $application->parent_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parent_contact') ? 'is-invalid' : '' }}" type="number" name="parent_contact" id="parent_contact" value="{{ old('parent_contact', $application->parent_contact) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('subcounty') ? 'is-invalid' : '' }}" name="subcounty" id="subcounty" required>
                    ...
                    @foreach(App\Models\Application::SUBCOUNTY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('subcounty', $application->subcounty) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ward') ? 'is-invalid' : '' }}" name="ward" id="ward" required>
                    ...
                    @foreach(App\Models\Application::WARD_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ward', $application->ward) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('ward'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('are_you_intrested_in') ? 'is-invalid' : '' }}" name="are_you_intrested_in" id="are_you_intrested_in" required>
                    ...
                    @foreach(App\Models\Application::ARE_YOU_INTRESTED_IN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('are_you_intrested_in', $application->are_you_intrested_in) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('skills_training') ? 'is-invalid' : '' }}" name="skills_training_id" id="skills_training_id">
                    @foreach($skills_trainings as $id => $entry)
                        <option value="{{ $id }}" {{ (old('skills_training_id') ? old('skills_training_id') : $application->skills_training->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('education') ? 'is-invalid' : '' }}" name="education" id="education">
                    ...
                    @foreach(App\Models\Application::EDUCATION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('education', $application->education) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qualification') ? 'is-invalid' : '' }}" type="text" name="qualification" id="qualification" value="{{ old('qualification', $application->qualification) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('grade') ? 'is-invalid' : '' }}" type="text" name="grade" id="grade" value="{{ old('grade', $application->grade) }}" required>
                @if($errors->has('grade'))
                    <div class="invalid-feedback">
                        {{ $errors->first('grade') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('year_of_experience') ? 'is-invalid' : '' }}" name="year_of_experience" id="year_of_experience" required>
                    ...
                    @foreach(App\Models\Application::YEAR_OF_EXPERIENCE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('year_of_experience', $application->year_of_experience) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" type="text" name="position" id="position" value="{{ old('position', $application->position) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('duties_responsibilities') ? 'is-invalid' : '' }}" name="duties_responsibilities" id="duties_responsibilities">{!! old('duties_responsibilities', $application->duties_responsibilities) !!}</textarea>
